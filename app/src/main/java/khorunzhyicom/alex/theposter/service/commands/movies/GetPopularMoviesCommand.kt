...
import khorunzhyicom.alex.theposter.api.actions.movies.PopularMoviesHttpAction
...
@CommandAction
class GetPopularMoviesCommand : khorunzhyicom.alex.theposter.service.commands.base.ApiCommand<List<Movie>>() {
    ...
    override fun run(callback: CommandCallback<List<Movie>>) {
        janet.createPipe(PopularMoviesHttpAction::class)
                .createObservableResult(PopularMoviesHttpAction())
