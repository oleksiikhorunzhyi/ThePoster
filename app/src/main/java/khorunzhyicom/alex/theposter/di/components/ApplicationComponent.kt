...
@Singleton
@Component(modules = arrayOf(AppModule::class, AndroidInjectionModule::class, InitializerModule::class, InteractorsModule::class, ApiConfigModule::class, JanetModule::class, ConverterModule::class))
